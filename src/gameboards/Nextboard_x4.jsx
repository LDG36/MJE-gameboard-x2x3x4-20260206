...
const Nextboard_x4 = ({ levelcounter3, setLevelcounter3 }) => {
  ...
  return (
    <div className="settingsContainer">
      ...
      {/* <Link to="/gameboard"> */}
      <button className="backToStartBtn" onClick={() => {setLevelcounter3(levelcounter3); navigate('/gameboard_x4') }}>
      ...
      <button className="startBtn2" onClick={() => {setLevelcounter3(prev => prev + 1); navigate('/gameboard_x4') }}>
